...
class STPhotoCommentsStyle {
    ...
    struct EmptyViewModel {
        var image: UIImage = UIImage(named: "comments_light", in: Bundle.module, compatibleWith: nil)!
    ...
    struct CommentsViewModel {
        ...
        var commentsButtonExpandedState: State {
            let image = UIImage(named: "comments_dark", in: Bundle.module, compatibleWith: nil)!
        ...
        var commentsButtonContractedState: State {
            let image = UIImage(named: "comments_light", in: Bundle.module, compatibleWith: nil)!
            let borderColor = UIColor(red: 170/255, green: 170/255, blue: 170/255, alpha: 0.3)
            let textAttributes: [NSAttributedString.Key: Any] = [
                NSAttributedString.Key.font: UIFont.systemFont(ofSize: 15),
                NSAttributedString.Key.foregroundColor: UIColor.lightGray
        ...
        var expandedAccessoryImage: UIImage = UIImage(named: "dark_arrow_up", in: Bundle.module, compatibleWith: nil)!
        var contractedAccessoryImage: UIImage = UIImage(named: "light_arrow_down", in: Bundle.module, compatibleWith: nil)!
    }
